...
| `WITH_IPFS_PI_STREAM`           | None                                           | Set to `true` if you want to install  Pi Stream Service to live stream your camera over IPFS. Requires a Raspberry Pi with camera module |
