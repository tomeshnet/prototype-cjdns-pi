...
| `WITH_H_DNS`                    | None                                           | Set to `true` if you want to use Hyperboria-compatible DNS servers: `fc4d:c8e5:9efe:9ac2:8e72:fcf7:6ce8:39dc` and `fc16:b44c:2bf9:467:8098:51c6:5849:7b4f` |
...
| `WITH_MESH_ID`                  | None                                           | Set the mesh ID for use with `WITH_MESH_POINT` |
